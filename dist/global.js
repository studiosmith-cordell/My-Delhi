...
var Timeline = /* @__PURE__ */ (function (_Animation) {
    ...
    _proto2.getTweensOf = function getTweensOf2(targets, onlyActive) {
        var a = [],
            parsedTargets = toArray2(targets),
            child = this._first,
...
var _initTween = function _initTween2(tween, time, tTime) {
    ...
    tween._yEase = yoyoEase
        ? _invertEase(
              _parseEase(yoyoEase === true ? ease : yoyoEase, _defaults2.ease)
          )
        : 0;
...
var Tween = /* @__PURE__ */ (function (_Animation2) {
    ...
    _proto3.kill = function kill(targets, vars) {
        ...
        var parsedTargets = this._targets,
            killingTargets = targets ? toArray2(targets) : parsedTargets,
...
var _gsap = {
    ...
    defaults: function defaults2(value) {
        value &&
            value.ease &&
            (value.ease = _parseEase(value.ease, _defaults2.ease));
...
var _getScrollFunc = function _getScrollFunc2(element, _ref) {
    ...
    prev ||
        (func.smooth =
            gsap2.getProperty(element, 'scrollBehavior') === 'smooth');
    return func;
};
    ...
    _proto.init = function init4(vars) {
        ...
        var id,
            ...
            _onClick = function _onClick2(e) {
                return (
                    _ignoreCheck(e) ||
                    (_getEvent(e, preventDefault) && onClick2(self))
                );
            };
...
var _refreshAll = function _refreshAll2(force, skipRevert) {
    ...
    _triggers.forEach(function (t2) {
        var max = _maxScroll(t2.scroller, t2._dir),
            endClamp = t2.vars.end === 'max' || (t2._endClamp && t2.end > max),
            startClamp = t2._startClamp && t2.start >= max;
        (endClamp || startClamp) &&
            t2.setPositions(
                startClamp ? max - 1 : t2.start,
                endClamp
                    ? Math.max(startClamp ? max : t2.start + 1, max)
                    : t2.end,
                true
            );
    });
...
var ScrollTrigger2 = /* @__PURE__ */ (function () {
    ...
    _proto.init = function init4(vars, animation) {
        ...
        var _vars = vars,
            ...
            markers = 'markers' in vars ? vars.markers : _defaults3.markers,
        ...
        if (snap3) {
            ...
            _scrollers.forEach(function (o) {
                return (
                    ...
                    o.target ===
                        (isViewport
                            ? _doc4.scrollingElement || _docEl2
                            : scroller) &&
                    (o.smooth = false)
                );
            });
        ...
        if (pin) {
            ...
            if (!pinCache.spacer) {
                ...
                pinCache.spacer = spacer =
                    pinSpacer || _doc4.createElement('div');
        ...
        self.refresh = function (soft, force, position, pinOffset) {
            ...
            if (markers && _isObject3(position)) {
                ...
                markerEndOffset = gsap3.getProperty(
                    markerEndTrigger,
                    direction.p
                );
            }
        ...
        self.getVelocity = function () {
            return (
                ((scrollFunc() - scroll2) / (_getTime2() - _time2)) * 1e3 || 0
            );
        };
        ...
        self.update = function (reset, recordVelocity, forceFake) {
            ...
            if (
                ...
                if (
                    ...
                    start <
                        scroll +
                            ((scroll - scroll2) / (_getTime2() - _time2)) *
                                anticipatePin
                ) {
                    clipped = 1e-4;
                } else if (
    ...
    ScrollTrigger3.enable = function enable() {
        ...
        if (gsap3) {
            ...
            _suppressOverwrites2 =
                gsap3.core.suppressOverwrites || _passThrough3;
    ...
    ScrollTrigger3.clearMatchMedia = function clearMatchMedia(query) {
        _triggers.forEach(function (t2) {
            return (
                t2._ctx && t2._ctx.query === query && t2._ctx.kill(true, true)
            );
        });
    };
...
var _getScrollNormalizer = function _getScrollNormalizer2(vars) {
    ...
    var _vars2 = vars,
        ...
        removeContentOffset = function removeContentOffset2() {
            content._gsap.y =
                _round3(parseFloat(content._gsap.y) + scrollFuncY.offset) +
                'px';
    ...
    vars.onRelease = vars.onGestureStart = function (self2, wasDragging) {
        ...
        if (!wasDragging) {
            ...
            if (normalizeScrollX) {
                ...
                endScroll =
                    currentScroll + (dur * 0.05 * -self2.velocityX) / 0.227;
...
var Emitter = class {
    ...
    on(t2, e) {
        return (
            this.events[t2]?.push(e) || (this.events[t2] = [e]),
            () => {
...
var VirtualScroll = class {
    ...
    onTouchStart = (t2) => {
        const { clientX: e, clientY: i } = t2.targetTouches
            ? t2.targetTouches[0]
            : t2;
        (this.touchStart.x = e),
            (this.touchStart.y = i),
...
var Lenis = class {
    constructor({
        ...
        duration: a,
        easing: c = (t3) => Math.min(1, 1.001 - Math.pow(2, -10 * t3)),
        lerp: p = !a && 0.1,
        infinite: u = false,
    ...
    onVirtualScroll = ({ deltaX: t2, deltaY: e, event: i }) => {
        ...
        const n = 0 === t2 && 0 === e,
            r =
                ...
                ('horizontal' === this.options.gestureOrientation && 0 === t2);
        if (n || r) return;
        ...
        if (
            ...
            l.find(
                (t3) =>
                    ...
                    (s && t3.hasAttribute?.('data-lenis-prevent-touch')) ||
                    (o && t3.hasAttribute?.('data-lenis-prevent-wheel')) ||
                    t3.classList?.contains('lenis')
            ))
        )
            return;
        ...
        'both' === this.options.gestureOrientation
            ? (h = Math.abs(e) > Math.abs(t2) ? e : t2)
            : 'horizontal' === this.options.gestureOrientation && (h = t2);
    ...
    get scroll() {
        return this.options.infinite
            ? ((t2 = this.animatedScroll), (e = this.limit), ((t2 % e) + e) % e)
            : this.animatedScroll;
        var t2, e;
    }
    get progress() {
    ...
    set isSmooth(t2) {
        this.__isSmooth !== t2 &&
            ((this.__isSmooth = t2), this.toggleClass('lenis-smooth', t2));
    }
    get isScrolling() {
    ...
    set isScrolling(t2) {
        this.__isScrolling !== t2 &&
            ((this.__isScrolling = t2),
            this.toggleClass('lenis-scrolling', t2));
    }
    get isStopped() {
    ...
    set isStopped(t2) {
        this.__isStopped !== t2 &&
            ((this.__isStopped = t2), this.toggleClass('lenis-stopped', t2));
    }
    get isLocked() {
    ...
    set isLocked(t2) {
        this.__isLocked !== t2 &&
            ((this.__isLocked = t2), this.toggleClass('lenis-locked', t2));
    }
    get className() {
        let t2 = 'lenis';
        return (
    ...
    toggleClass(t2, e) {
        this.rootElement.classList.toggle(t2, e),
